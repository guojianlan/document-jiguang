---
name: article-visual-assets
description: Use this skill when the user already has an article, publish brief, or social copy and wants a reusable set of visual assets such as SVG covers, cognition diagrams, social cards, plus PNG preview validation and optional PNG export.
---
