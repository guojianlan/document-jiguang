...
related_topics: [claude-code, codex, ai-agent, ai-workflow, model-capability-shift]
status: active
...
- **可回退**：[[claude-code|Claude Code]] 在执行前自动 [[claude-code#核心机制|checkpoint]]，让 agent 敢做大动作
...
- **AGENTS.md**：把"agent 该怎么在这个仓库工作"写成约定文件，[[codex|Codex]] / Cursor / GitHub Copilot 等多工具共享同一份约定（自 2025-08 起 60,000+ 项目采用）
- **Cloud sandbox**：把任务放到隔离环境跑，可以跑很久
- **核心命题**：autonomy 通过"换个安全环境"实现，模型本身不需要改

来源：[[2026-03-23_pdf_openai_how-openai-uses-codex]] + [[2026-03-23_article_openai_get-started-with-codex]] + [[2026-03-23_article_openai_practical-guide-building-ai-agents]] + [[2026-03-23_article_openai_agentic-ai-foundation-agents-md]]
...
- vs [[ai-agent|AI Agent]]：autonomy 是 AI Agent 的一个维度（agent 的其它维度还包括工具调用、协作、记忆）
- vs [[ai-workflow|AI 工作流]]：autonomy 决定工作流里"哪些环节交给 agent"，工作流决定"agent 在系统中的位置"
